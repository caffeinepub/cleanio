...
const CLEANING_OPTIONS: {
...
}[] = [
  {
    ...
    price: 199,
    description:
      "Premium coloured foam wash with deep cleaning action and a vibrant finish.",
    emoji: "🌈",
    highlights: [
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Showroom-finish doorstep cleaning
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Our professional cleaning service uses eco-friendly products and
                high-pressure washing to restore your bike's shine. Perfect for
                regular maintenance or before special occasions.
              </p>
            </div>
          </div>
