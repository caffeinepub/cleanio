  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center space-y-8">
        {/* Icon */}
        <div className="w-24 h-24 bg-red-500/15 border-2 border-red-500/30 rounded-full flex items-center justify-center mx-auto">
        ...
        {/* Info card */}
        <div className="bg-card border border-red-500/20 rounded-2xl p-5 text-left space-y-3">
          <p className="text-sm font-semibold text-foreground">
            What you can do:
          </p>
          {[
            "Try again with the same or a different payment method",
            "Contact us on WhatsApp to purchase manually",
            "Check your bank if you think a charge went through",
          ].map((item) => (
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Button
            variant="outline"
            onClick={() => navigate({ to: "/" })}
            data-ocid="payment_failure.home.button"
            className="border-border text-foreground hover:bg-charcoal-light hover:border-brand-orange/50 px-8 py-3 rounded-xl transition-all"
          >
        ...
        <a
          ...
          data-ocid="payment_failure.whatsapp.button"
          className="inline-flex items-center gap-2 text-sm font-medium text-green-400 hover:underline transition-all"
        >
          <svg
