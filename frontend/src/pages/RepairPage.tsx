  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="font-display font-black text-2xl md:text-3xl text-foreground">Repair Service</h1>
          <p className="text-muted-foreground text-sm">AI-assisted diagnosis & expert repair</p>
        </div>
      </div>
      ...
      {isComplete && (
        <div className="bg-card border border-border rounded-2xl p-6 animate-fade-in-up">
          <h2 className="font-display font-bold text-xl text-foreground mb-2">Book Your Repair</h2>
